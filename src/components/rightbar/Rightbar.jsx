  ...
  return (
    <div className="Rightbar">
      <div className="userCard">
        <img
          className="userCardImg userCardItem"
          ...
          alt="user"
        />
        <h1 className="userCardItem">demo@devias.io</h1>
        <p className="userCardItem yourTier">
          your tier: <span color="purple">Premium</span>
        </p>
      </div>
      <hr />
